...
#define __cam_assign_str(field, string) __assign_str(field)
#else
#define __cam_assign_str(field, string) __assign_str(field, string)
#endif
...
TRACE_EVENT(cam_log_event,
	...
	TP_fast_assign(
		__cam_assign_str(string1, string1);
		__cam_assign_str(string2, string2);
		__entry->val1 = val1;
		__entry->val2 = val2;
	),
	TP_printk(
...
TRACE_EVENT(cam_icp_fw_dbg,
	...
	TP_fast_assign(
		__cam_assign_str(dbg_message, dbg_message);
		__entry->timestamp = timestamp;
		__cam_assign_str(dev_name, dev_name);
	),
	TP_printk(
		"[%s] %llu %s: ",
...
TRACE_EVENT(cam_buf_done,
	...
	TP_fast_assign(
		__cam_assign_str(ctx_type, ctx_type);
		__entry->ctx = ctx;
		__entry->link_hdl = ctx->link_hdl;
...
TRACE_EVENT(cam_apply_req,
	...
	TP_fast_assign(
		__cam_assign_str(entity, entity);
		__entry->id = id;
...
TRACE_EVENT(cam_req_mgr_connect_device,
	...
	TP_fast_assign(
		__cam_assign_str(name, info->name);
...
TRACE_EVENT(cam_req_mgr_apply_request,
	...
	TP_fast_assign(
		__cam_assign_str(name, dev->dev_info.name);
