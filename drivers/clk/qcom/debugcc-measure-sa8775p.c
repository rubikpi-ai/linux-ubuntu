...
static struct clk_fixed_rate measure_only_gcc_disp1_ahb_clk = {
	.fixed_rate = 1000,
	.hw.init = &(const struct clk_init_data){
...
static struct clk_fixed_rate measure_only_gcc_disp1_xo_clk = {
	.fixed_rate = 1000,
	.hw.init = &(const struct clk_init_data){
...
static struct clk_fixed_rate measure_only_mdss_0_disp_cc_xo_clk = {
	.fixed_rate = 1000,
	.hw.init = &(const struct clk_init_data){
...
static struct clk_fixed_rate measure_only_mdss_1_disp_cc_xo_clk = {
	.fixed_rate = 1000,
	.hw.init = &(const struct clk_init_data){
